...
backgroundElement.childNodes[1].style.fill=predefinedColors[randseedConverted[6]];for(let i=0;i<eyesElement.childNodes.length;i++){if(eyesElement.childNodes[i].className){if(eyesElement.childNodes[i].className.animVal==='main'){eyesElement.childNodes[i].style.fill=predefinedColors[randseedConverted[7]];}}}}
