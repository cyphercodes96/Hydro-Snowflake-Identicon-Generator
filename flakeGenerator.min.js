...
function createIcon(opts){opts=buildOpts(opts||{});var parser=new DOMParser();var doc=parser.parseFromString(svg,"image/svg+xml");randLayers();randFaceFlakeColor();randBackgroundColor();randEyesColor();switchLayers(doc);switchColors(doc);doc.documentElement.style.height=opts.size+'px';document.body.appendChild(doc.documentElement);return doc.documentElement;}
